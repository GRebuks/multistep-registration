                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    ...
                    <a href="https://laracasts.com" class="scale-100 p-6 bg-white from-gray-700/50 via-transparent rounded-lg shadow-2xl shadow-gray-500/20 flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900">Lorem ipsum</h2>

                            <p class="mt-4 text-gray-500 text-sm leading-relaxed">
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus aliquam consectetur, error est et excepturi explicabo facere illo incidunt ipsum laudantium magni minima natus necessitatibus, neque officiis quae, quaerat unde.
                            </p>
                        </div>
                    ...
                    <a href="https://laravel-news.com" class="scale-100 p-6 bg-white from-gray-700/50 via-transparent rounded-lg shadow-2xl shadow-gray-500/20 flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                        <div>
                            ...
                            <p class="mt-4 text-gray-500 text-sm leading-relaxed">
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias officiis, voluptate. Cumque eos error facilis fugiat non omnis velit! Ducimus ea eos in quisquam. Dolor fuga fugiat harum labore quidem!
                            </p>
                        </div>
